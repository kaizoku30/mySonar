...
class MyAddressView: UIView {
    ...
    func showDeletePopUp(id: String, isDefault: Bool = false, otherAddresses: [MyAddressListItem]? = nil) {
        ...
        popUpAlert.configure(message: LocalizedStrings.MyAddress.showDeletePopUpMessage, leftButtonTitle: LocalizedStrings.MyAddress.cancel, rightButtonTitle: LocalizedStrings.MyAddress.delete, container: self)
