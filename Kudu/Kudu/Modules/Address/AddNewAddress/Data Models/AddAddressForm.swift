...
struct AddAddressForm {
    var addressLabel: APIEndPoints.AddressLabelType = .HOME
    ...
    enum FormEntry {
        ...
        case addressLabel(APIEndPoints.AddressLabelType)
    ...
    mutating func updateWithAddressItem(_ item: MyAddressListItem) {
        ...
        self.update(.addressLabel(APIEndPoints.AddressLabelType(rawValue: item.addressLabel ?? "") ?? .HOME))
